 ...
 *
 * Description: If the file is not an ELF file - exit the code 98.
 */
...
/**
 * print_class - This will  Prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_version - This prints theversion of an ELF header.
